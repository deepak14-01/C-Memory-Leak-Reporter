...
main(int argc, char **argv){
    ...
    //Initializing a new database to store structures
    struct_db_t *struct_db = calloc(1, sizeof(struct_db_t));
    mld_init_primitive_data_types_support(struct_db);
        
    //Creating record for individual structure - emp_t
    ...
    //Registering the structure(emp_t) in structure database (struct_db)
